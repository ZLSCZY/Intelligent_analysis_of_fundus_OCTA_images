...
def get_train_utils(opt, model_parameters):
    ...
    if opt.distributed:
        ...
        train_sampler = None
    print(len(train_data), (train_sampler is None), opt.n_threads)
...
def get_inference_utils(opt):
    ...
    inference_data, collate_fn = get_inference_data(
        ...
        temporal_transform, d_i=opt.direct_index)
...
def main_worker(index, opt):
    ...
    model = torch.nn.DataParallel(generate_model(opt))
