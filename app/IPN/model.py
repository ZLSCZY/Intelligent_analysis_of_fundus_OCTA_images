...
from models import resnet, resnet2p1d, pre_act_resnet, wide_resnet, resnext, densenet, vgg_series
...
def generate_model(opt):
    assert opt.model in [
        'resnet', 'resnet2p1d', 'preresnet', 'wideresnet', 'resnext', 'densenet','vgg'
    ]
    ...
    if opt.model == 'resnet':
        ...
        model = vgg_series.Vgg(num_classes=3,init_weights=True)
