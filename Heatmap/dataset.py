...
from Heatmap.datasets.videodataset import VideoDataset
from Heatmap.datasets.videodataset_multiclips import (VideoDatasetMultiClips,
                                              collate_fn)
from Heatmap.datasets.activitynet import ActivityNet
from Heatmap.datasets.loader import VideoLoader, VideoLoaderHDF5, VideoLoaderFlowHDF5


def image_name_formatter(x):
    return f'{x}.jpg'    # f'image_{x:05d}.jpg'
